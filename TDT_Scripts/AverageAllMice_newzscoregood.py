...
def load_sessions(path = r"/Users/shivasenthilkumar/Desktop/Robinson_Lab/Scripts/TDT_Scripts/DATA/Looming"): 
...
for d in range(1, len(data_sessions)):
...
#%% In [14] Heat map based on z-score of 405 fit subtracted 465
...
#the spacing of the ticks on teh x-axis
tick_spacing = 50
